...
def main():
    ...
    order_generator = MomentumOrderGenerator()
    ...
    metrics_calculator.plot_returns(returns, benchmark_returns=benchmark_returns, title="Momentum Strategy vs S&P 500", save_path="momentum_vs_spy.png")
